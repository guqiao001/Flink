...
public class SocketSourceEventTimeSlidingWindow {
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<Tuple2<String, Integer>, Tuple, TimeWindow> window = keyed.window(SlidingEventTimeWindows.of(Time.of(6, TimeUnit.SECONDS), Time.of(2, TimeUnit.SECONDS)));
